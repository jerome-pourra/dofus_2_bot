...
export class FriendsGetListMessage extends NetworkMessage implements INetworkMessage
{
    ...
    {
        return FriendsGetListMessage.endpointClient;
    }

    public isEndpointServer()
    {
        return FriendsGetListMessage.endpointServer;
    }
    ...
    private deserializeAs_FriendsGetListMessage(input: ICustomDataInput)
    {

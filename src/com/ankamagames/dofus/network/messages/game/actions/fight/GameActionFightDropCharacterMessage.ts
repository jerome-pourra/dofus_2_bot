...
export class GameActionFightDropCharacterMessage extends AbstractGameActionMessage implements INetworkMessage
{
    ...
    public serializeAs_GameActionFightDropCharacterMessage(output: ICustomDataOutput)
    {
